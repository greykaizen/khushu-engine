...
| Item | Status | Gate |
|---|---|---|
| Fajr-at-anti-transit persistent-twilight policy | 🟨 review dossier complete 2026-08-30 (`docs/aqrab-al-ayyam-review.md`: Muwaqqit thesis + all 12 cited authorities, our strong/weak assessment, engine consequence = opt-in HighLatitudeRule variant if approved) | knowledgeable-reader ruling on the 3 decision questions in the dossier; the `sun.antiTransit` fact it needs is already shipped (v1.14) |
