...
| qibla | ✅ locked | bearing + distance owned by engine; shadow-verification + relative sun angle + `audit()` provenance; cross-checked vs adhan2 (docs/divergences.md D5); v1.10: `relativeSunAngle` moved into module (facade delegates), shadow-cache in CachedEngine |
