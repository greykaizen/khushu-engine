...
| zakat | ✅ locked | mal + fitrana + hawl + livestock schedules + ushr + rikaz; fiqh spot cases + property tests; rate 0.025, madhab rules, saʿ conventions documented; v1.10: dual nisab thresholds, madhab-rule `notes`, `AssetKey` i18n keys, `totalKg`, `hawlFacts` countdown |
