...
dependencies {
    ...
    implementation("com.github.greykaizen.khushu-engine:engine-facade:1.11.0")
}
```
...
dependencies { implementation("com.khushu:engine-facade:1.11.0") }
```
...
then depend on `com.khushu:engine-facade:1.11.0` — Gradle substitutes the
local project.
...
```kotlin
implementation("com.github.greykaizen.khushu-engine:store:1.11.0")   // JitPack
// or mavenLocal: implementation("com.khushu:store:1.11.0")
```
